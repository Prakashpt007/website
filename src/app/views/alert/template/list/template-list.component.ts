...
export class TemplateListComponent {
	...
	editUrl: string = "/alert/template/form";
	listUrl: string = "alert/template";
	...
	async getData () {
		...
		this.router.navigate(["/alert/template/list"], {queryParams: params});
		this.listTableData = [];
		this.showListBuilder = false;
		// List Data
		this.genericHttp.getDataList(this.listUrl, params).subscribe(
			// this.genericHttp.getDummyData('assets/jsons/template-list.json').subscribe(
			(response) => {

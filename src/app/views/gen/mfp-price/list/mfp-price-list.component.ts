...
@Component({
	selector: 'app-mfp-price-list',
	templateUrl: './mfp-price-list.component.html',
	styleUrl: './mfp-price-list.component.scss',
	standalone: false
})
export class MfpPriceListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/mfp-price/form";
	listUrl: string = "gen/mfp-price";
	...
	async getData () {
		...
		this.router.navigate(["/gen/mfp-price/list"], {queryParams: params});
		this.listTableData = [];

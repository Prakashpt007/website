...
@Component({
	selector: 'app-company-warehouse-list',
	templateUrl: './company-warehouse-list.component.html',
	styleUrl: './company-warehouse-list.component.scss',
	standalone: false
})
export class CompanyWarehouseListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/warehouse-qa/company-warehouse/form";
	listUrl: string = "warehouse-doc-validation/get-warehouse-company-list";
	...
	async getData () {
		...
		this.router.navigate(["/warehouse-qa/company-warehouse/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-tender-type-list',
	templateUrl: './tender-type-list.component.html',
	styleUrls: ['./tender-type-list.component.scss'],
	standalone: false
})
export class TenderTypeListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/tender-type/form";
	listUrl: string = "gen/tender-type";
	...
	async getData () {
		...
		this.router.navigate(["/gen/tender-type/list"], {queryParams: params});
		this.listTableData = [];

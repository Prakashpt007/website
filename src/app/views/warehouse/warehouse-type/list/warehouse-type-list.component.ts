...
@Component({
	...
	styleUrls: ['./warehouse-type-list.component.scss'],
	standalone: false
})
export class WarehouseTypeListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/warehouse/type/form";
	listUrl: string = "warehouse/warehouse-type";
	...
	async getData () {
		...
		this.router.navigate(["/warehouse/type/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-commodity-price-list',
	templateUrl: './commodity-price-list.component.html',
	styleUrl: './commodity-price-list.component.scss',
	standalone: false
})
export class CommodityPriceListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/regional/commodity-price/form";
	listUrl: string = "regional/commodity-price";
	...
	async getData () {
		...
		this.router.navigate(["/regional/commodity-price/list"], {queryParams: params});
		this.listTableData = [];

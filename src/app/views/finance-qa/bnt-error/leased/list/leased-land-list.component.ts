...
@Component({
	selector: 'app-leased-land-list',
	templateUrl: './leased-land-list.component.html',
	standalone: false
})
export class LeasedLandListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/finance-qa/bnt-error/leased-land/form";
	listUrl: string = "farm-leased-bnt-error/get-list";
	...
	async getData () {
		...
		this.router.navigate(["/finance-qa/bnt-error/leased-land/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	...
	styleUrls: ['./user-menu-list.component.scss'],
	standalone: false
})
export class UserMenuListComponent {
	...
	editUrl: string = "/acl/user-menu/form";
	listUrl: string = "menu/activity-menu";
	...
	async getData () {
		...
		this.router.navigate(["/acl/user-menu/list"], {queryParams: params});
		this.listTableData = [];

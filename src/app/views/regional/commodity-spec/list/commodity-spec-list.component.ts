...
@Component({
	...
	templateUrl: './commodity-spec-list.component.html',
	styleUrl: './commodity-spec-list.component.scss',
	standalone: false
})
export class CommoditySpecListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/regional/commodity-spec/form";
	listUrl: string = "regional/commodity-spec";
	...
	async getData () {
		...
		this.router.navigate(["/regional/commodity-spec/list"], {queryParams: params});
		this.listTableData = [];

...
export class AlertListComponent {
	...
	editUrl: string = "/alert/alert/form";
	listUrl: string = "alert/alert";
	...
	async getData () {
		...
		this.router.navigate(["/alert/alert/list"], {queryParams: params});
		this.listTableData = [];
		this.showListBuilder = false;
		// List Data
		this.genericHttp.getDataList(this.listUrl, params).subscribe(
			// this.genericHttp.getDummyData('assets/jsons/alert-list.json').subscribe(
			(response) => {

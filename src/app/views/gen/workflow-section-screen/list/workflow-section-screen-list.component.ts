...
@Component({
	selector: 'app-workflow-section-screen-list',
	templateUrl: './workflow-section-screen-list.component.html',
	styleUrl: './workflow-section-screen-list.component.scss',
	standalone: false
})
export class WorkflowSectionScreenListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/workflow-section-screen/form";
	listUrl: string = "gen/workflow-section-screen";
	...
	async getData () {
		...
		this.router.navigate(["/gen/workflow-section-screen/list"], {queryParams: params});
		this.listTableData = [];

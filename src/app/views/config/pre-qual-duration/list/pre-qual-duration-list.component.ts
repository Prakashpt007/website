...
@Component({
	selector: 'app-pre-qual-duration-list',
	templateUrl: './pre-qual-duration-list.component.html',
	styleUrl: './pre-qual-duration-list.component.scss',
	standalone: false
})
export class PreQualDurationListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/config/pre-qual-duration/form";
	listUrl: string = "config/pq-duration";
	...
	async getData () {
		...
		this.router.navigate(["/config/pre-qual-duration/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	...
	styleUrls: ['./visit-time-list.component.scss'],
	standalone: false
})
export class VisitTimeListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/regional/visit-time/form";
	listUrl: string = "regional/visit-time";
	...
	async getData () {
		...
		this.router.navigate(["/regional/visit-time/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-commodity-pmp-decrease-percent-list',
	templateUrl: './commodity-pmp-decrease-percent-list.component.html',
	styleUrl: './commodity-pmp-decrease-percent-list.component.scss',
	standalone: false
})
export class CommodityPmpDecreasePercentListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/config/commodity-pmp-decrease-percent/form";
	listUrl: string = "config/commodity-pmp-decrease-percent";
	...
	async getData () {
		...
		this.router.navigate(["/config/commodity-pmp-decrease-percent/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-harvested-geo-tag-list',
	templateUrl: './harvested-geo-tag-list.component.html',
	styleUrl: './harvested-geo-tag-list.component.scss',
	standalone: false
})
export class HarvestedGeoTagListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/geo-qa/harvested-geo-tag/form";
	listUrl: string = "geo-tag-validation/get-harvested-list";
	...
	async getData () {
		...
		this.router.navigate(["/geo-qa/harvested-geo-tag/list"], {queryParams: params});
		this.listTableData = [];

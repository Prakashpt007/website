...
@Component({
	selector: 'app-commodity-parameter-list',
	templateUrl: './commodity-parameter-list.component.html',
	styleUrls: ['./commodity-parameter-list.component.scss'],
	standalone: false
})
export class CommodityParameterListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/agri/commodity-parameter/form";
	listUrl: string = "agri/commodity-parameter";
	...
	async getData () {
		...
		this.router.navigate(["/agri/commodity-parameter/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-state-commodity-list',
	templateUrl: './state-commodity-list.component.html',
	styleUrls: ['./state-commodity-list.component.scss'],
	standalone: false
})
export class StateCommodityListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/agri/state-commodity/form";
	listUrl: string = "agri/state-commodity";
	...
	async getData () {
		...
		this.router.navigate(["/agri/state-commodity/list"], {queryParams: params});
		this.listTableData = [];

...
export class BankAccountListComponent {
	...
	editUrl: string = "/finance-qa/bnt-error/bank-account/form";
	listUrl: string = "bank-account-bnt-errors/get-list";
	...
	async getData () {
		...
		this.router.navigate(["/finance-qa/bnt-error/bank-account/list"], {queryParams: params});
		this.listTableData = [];

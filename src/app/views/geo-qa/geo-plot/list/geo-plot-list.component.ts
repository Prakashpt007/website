...
@Component({
	selector: 'app-geo-plot-list',
	templateUrl: './geo-plot-list.component.html',
	styleUrl: './geo-plot-list.component.scss',
	standalone: false
})
export class GeoPlotListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/geo-qa/geo-plot/form";
	listUrl: string = "geo-plotting-validation/get-list";
	...
	async getData () {
		...
		this.router.navigate(["/geo-qa/geo-plot/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-subm-menu-list',
	templateUrl: './subm-menu-list.component.html',
	styleUrls: ['./subm-menu-list.component.scss'],
	standalone: false
})
export class SubmMenuListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/acl/submenu/form";
	listUrl: string = "menu/sub-menu";
	...
	async getData () {
		...
		this.router.navigate(["/acl/submenu/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-company-proof-of-order-list',
	templateUrl: './company-proof-of-order-list.component.html',
	styleUrl: './company-proof-of-order-list.component.scss',
	standalone: false
})
export class CompanyProofOfOrderListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/finance-qa/company-proof-of-order/form";
	listUrl: string = "company-proof-of-order-completion-doc-validation/get-list";
	...
	async getData () {
		...
		this.router.navigate(["/finance-qa/company-proof-of-order/list"], {queryParams: params});
		this.listTableData = [];

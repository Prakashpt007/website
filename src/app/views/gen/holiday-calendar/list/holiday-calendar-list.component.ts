...
@Component({
	...
	styleUrls: ['./holiday-calendar-list.component.scss'],
	standalone: false
})
export class HolidayCalendarListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/holiday-calendar/form";
	listUrl: string = "gen/holiday-calendar";
	...
	async getData () {
		...
		this.router.navigate(["/gen/holiday-calendar/list"], {queryParams: params});
		this.listTableData = [];

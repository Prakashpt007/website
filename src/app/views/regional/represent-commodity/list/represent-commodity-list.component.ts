...
@Component({
	selector: 'app-represent-commodity-list',
	templateUrl: './represent-commodity-list.component.html',
	styleUrl: './represent-commodity-list.component.scss',
	standalone: false
})
export class RepresentCommodityListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/regional/represent-commodity/form";
	listUrl: string = "regional/represent-commodity";
	...
	async getData () {
		...
		this.router.navigate(["/regional/represent-commodity/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-lot-default-quantity-list',
	templateUrl: './lot-default-quantity-list.component.html',
	styleUrl: './lot-default-quantity-list.component.scss',
	standalone: false
})
export class LotDefaultQuantityListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/config/lot-default-quantity/form";
	listUrl: string = "config/lot-default-quantity";
	...
	async getData () {
		...
		this.router.navigate(["/config/lot-default-quantity/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-commodity-benchmark-market-list',
	templateUrl: './commodity-benchmark-market-list.component.html',
	styleUrl: './commodity-benchmark-market-list.component.scss',
	standalone: false
})
export class CommodityBenchmarkMarketListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/commodity-benchmark-market/form";
	listUrl: string = "gen/commodity-benchmark-market";
	...
	async getData () {
		...
		this.router.navigate(["/gen/commodity-benchmark-market/list"], {queryParams: params});
		this.listTableData = [];

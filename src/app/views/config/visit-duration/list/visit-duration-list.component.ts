...
@Component({
	selector: 'app-visit-duration-list',
	templateUrl: './visit-duration-list.component.html',
	styleUrl: './visit-duration-list.component.scss',
	standalone: false
})
export class VisitDurationListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/config/visit-duration/form";
	listUrl: string = "config/visit-duration";
	...
	async getData () {
		...
		this.router.navigate(["/config/visit-duration/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	...
	styleUrl: './service-charge-list.component.scss',
	standalone: false
})
export class ServiceChargeListComponent {
	...
	editUrl: string = "/config/service-charge/form";
	listUrl: string = "config/service-charge";
	...
	async getData () {
		...
		this.router.navigate(["/config/service-charge/list"], {queryParams: params});
		this.listTableData = [];

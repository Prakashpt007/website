...
@Component({
	selector: 'app-farmer-warehouse-list',
	templateUrl: './farmer-warehouse-list.component.html',
	styleUrl: './farmer-warehouse-list.component.scss',
	standalone: false
})
export class FarmerWarehouseListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/warehouse-qa/farmer-warehouse/form";
	listUrl: string = "warehouse-doc-validation/get-warehouse-farmer-list";
	...
	async getData () {
		...
		this.router.navigate(["/warehouse-qa/farmer-warehouse/list"], {queryParams: params});
		this.listTableData = [];

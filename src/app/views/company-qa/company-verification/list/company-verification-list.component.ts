...
@Component({
	selector: 'app-company-verification-list',
	templateUrl: './company-verification-list.component.html',
	styleUrl: './company-verification-list.component.scss',
	standalone: false
})
export class CompanyVerificationListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/company-qa/verification/form";
	listUrl: string = "company-verification/get-list";
	...
	async getData () {
		...
		this.router.navigate(["/company-qa/verification/list"], {queryParams: params});
		this.listTableData = [];

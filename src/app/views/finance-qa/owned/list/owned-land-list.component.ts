...
export class OwnedLandListComponent {
	...
	editUrl: string = "/finance-qa/owned-land/form";
	listUrl: string = "land-doc-validation/get-owned-list";
	...
	async getData () {
		...
		this.router.navigate(["/finance-qa/owned-land/list"], {queryParams: params});
		this.listTableData = [];

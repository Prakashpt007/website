...
@Component({
	selector: 'app-doc-approve-reject-modal',
	standalone: true,
	imports: [ReactiveFormsModule, CommonModule, FormatTextPipe],
	templateUrl: './doc-approve-reject-modal.component.html',
	styleUrl: './doc-approve-reject-modal.component.scss',
	animations: [
		trigger("fade", [
			transition("void => *", [
				style({opacity: 0}),
...
export class DocApproveRejectModalComponent {

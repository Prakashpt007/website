...
@Component({
	selector: 'app-non-msp-price-list',
	templateUrl: './non-msp-price-list.component.html',
	styleUrl: './non-msp-price-list.component.scss',
	standalone: false
})
export class NonMspPriceListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/non-msp-price/form";
	listUrl: string = "gen/non-msp-price";
	...
	async getData () {
		...
		this.router.navigate(["/gen/non-msp-price/list"], {queryParams: params});
		this.listTableData = [];

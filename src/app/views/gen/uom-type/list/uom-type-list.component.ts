...
@Component({
	selector: 'app-uom-type-list',
	templateUrl: './uom-type-list.component.html',
	styleUrls: ['./uom-type-list.component.scss'],
	standalone: false
})
export class UomTypeListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/uom-type/form";
	listUrl: string = "gen/uom-type";
	...
	async getData () {
		...
		this.router.navigate(["/gen/uom-type/list"], {queryParams: params});
		this.listTableData = [];

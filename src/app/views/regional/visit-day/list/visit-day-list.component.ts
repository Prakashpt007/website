...
@Component({
	selector: 'app-visit-day-list',
	templateUrl: './visit-day-list.component.html',
	styleUrls: ['./visit-day-list.component.scss'],
	standalone: false
})
export class VisitDayListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/regional/visit-day/form";
	listUrl: string = "regional/visit-day";
	...
	async getData () {
		...
		this.router.navigate(["/regional/visit-day/list"], {queryParams: params});
		this.listTableData = [];

...
export class BankAccountListComponent {
	...
	editUrl: string = "/finance-qa/bank-account/form";
	listUrl: string = "bank-account-doc-validation/get-list";
	...
	async getData () {
		...
		this.router.navigate(["/finance-qa/bank-account/list"], {queryParams: params});
		this.listTableData = [];

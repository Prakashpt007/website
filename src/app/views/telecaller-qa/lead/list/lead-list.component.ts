...
export class LeadListComponent {
	...
	editUrl: string = "/telecaller-qa/lead/form";
	listUrl: string = "lead/get-list";
	...
	async getData () {
		...
		this.router.navigate(["/telecaller-qa/lead/list"], {queryParams: params});
		this.listTableData = [];
		...
		this.genericHttp.getDataList(this.listUrl, params).subscribe({
			...
			error: (err: any) => {
				...
				if (err.status == 404) {
					...
					this.toastr.error(`Access Denied`, `401 - Unauthorized`);

...
export class CompanyListComponent {
	...
	editUrl: string = "/finance-qa/bnt-error/company/form";
	listUrl: string = "company-bnt-errors/get-list";
	...
	async getData () {
		...
		this.router.navigate(["/finance-qa/bnt-error/company/list"], {queryParams: params});
		this.listTableData = [];

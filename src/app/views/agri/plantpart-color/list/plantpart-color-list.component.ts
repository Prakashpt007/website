...
@Component({
	selector: 'app-plantpart-color-list',
	templateUrl: './plantpart-color-list.component.html',
	styleUrls: ['./plantpart-color-list.component.scss'],
	standalone: false
})
export class PlantpartColorListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/agri/plantpart-color/form";
	listUrl: string = "agri/plantpart-color";
	...
	async getData () {
		...
		this.router.navigate(["/agri/plantpart-color/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-company-turnover-list',
	templateUrl: './company-turnover-list.component.html',
	styleUrl: './company-turnover-list.component.scss',
	standalone: false
})
export class CompanyTurnoverListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/finance-qa/company-turnover/form";
	listUrl: string = "company-proof-of-turnover-doc-validation/get-list";
	...
	async getData () {
		...
		this.router.navigate(["/finance-qa/company-turnover/list"], {queryParams: params});
		this.listTableData = [];

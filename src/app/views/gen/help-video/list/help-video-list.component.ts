...
@Component({
	selector: 'app-help-video-list',
	templateUrl: './help-video-list.component.html',
	styleUrls: ['./help-video-list.component.scss'],
	standalone: false
})
export class HelpVideoListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/help-video/form";
	listUrl: string = "gen/help-video";
	...
	async getData () {
		...
		this.router.navigate(["/gen/help-video/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-quantity-threshold-list',
	templateUrl: './quantity-threshold-list.component.html',
	styleUrl: './quantity-threshold-list.component.scss',
	standalone: false
})
export class QuantityThresholdListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/quantity-threshold/form";
	listUrl: string = "gen/quantity-threshold";
	...
	async getData () {
		...
		this.router.navigate(["/gen/quantity-threshold/list"], {queryParams: params});
		this.listTableData = [];

...
export class LeasedLandListComponent {
	...
	editUrl: string = "/finance-qa/leased-land/form";
	listUrl: string = "land-doc-validation/get-leased-list";
	...
	async getData () {
		...
		this.router.navigate(["/finance-qa/leased-land/list"], {queryParams: params});
		this.listTableData = [];

...
export class PendingListComponent {
	...
	editUrl: string = "/incomplete/pending/edit";
	viewUrl: string = "/incomplete/pending/view";
	listUrl: string = "incomplete-cases/get-pending-list";
	...
	async getData () {
		...
		this.router.navigate(["/incomplete/pending/list"], {queryParams: params});
		this.listTableData = [];

...
export class ChannelListComponent {
	...
	editUrl: string = "/alert/channel/form";
	listUrl: string = "alert/channel";
	...
	async getData () {
		...
		this.router.navigate(["/alert/channel/list"], {queryParams: params});
		this.listTableData = [];
		this.showListBuilder = false;
		// List Data
		this.genericHttp.getDataList(this.listUrl, params).subscribe(
			// this.genericHttp.getDummyData('assets/jsons/channel-list.json').subscribe(
			(response) => {

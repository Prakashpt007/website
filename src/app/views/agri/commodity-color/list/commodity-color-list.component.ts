...
@Component({
	selector: 'app-commodity-color-list',
	templateUrl: './commodity-color-list.component.html',
	styleUrl: './commodity-color-list.component.scss',
	standalone: false
})
export class CommodityColorListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/agri/commodity-color/form";
	listUrl: string = "agri/commodity-color";
	...
	async getData () {
		...
		this.router.navigate(["/agri/commodity-color/list"], {queryParams: params});
		this.listTableData = [];

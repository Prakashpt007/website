...
@Component({
	selector: 'app-advance-percent-list',
	templateUrl: './advance-percent-list.component.html',
	styleUrl: './advance-percent-list.component.scss',
	standalone: false
})
export class AdvancePercentListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/config/advance-percent/form";
	listUrl: string = "config/advance-percent";
	...
	async getData () {
		...
		this.router.navigate(["/config/advance-percent/list"], {queryParams: params});
		this.listTableData = [];

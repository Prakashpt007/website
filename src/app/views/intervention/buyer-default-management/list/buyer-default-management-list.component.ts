...
@Component({
	selector: 'app-buyer-default-management-list',
	standalone: false,
	templateUrl: './buyer-default-management-list.component.html',
	styleUrl: './buyer-default-management-list.component.scss'
})
export class BuyerDefaultManagementListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	listUrl: string = "intervention/buyer-default-management";
	...
	async getData () {
		...
		this.router.navigate(["/intervention/buyer-default-management/list"], {queryParams: params});
		this.listTableData = [];

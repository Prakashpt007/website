...
@Component({
	...
	styleUrl: './agm-list.component.scss',
	standalone: false
})
export class AgmListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/config/agm/form";
	listUrl: string = "config/agm";
	...
	async getData () {
		...
		this.router.navigate(["/config/agm/list"], {queryParams: params});
		this.listTableData = [];

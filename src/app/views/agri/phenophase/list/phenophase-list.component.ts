...
@Component({
	selector: 'app-phenophase-list',
	templateUrl: './phenophase-list.component.html',
	styleUrls: ['./phenophase-list.component.scss'],
	standalone: false
})
export class PhenophaseListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/agri/phenophase/form";
	listUrl: string = "agri/phenophase";
	...
	async getData () {
		...
		this.router.navigate(["/agri/phenophase/list"], {queryParams: params});
		this.listTableData = [];

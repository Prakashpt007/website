...
@Component({
	selector: 'app-delta-margin-band-list',
	templateUrl: './delta-margin-band-list.component.html',
	styleUrl: './delta-margin-band-list.component.scss',
	standalone: false
})
export class DeltaMarginBandListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/config/delta-margin-band/form";
	listUrl: string = "config/delta-margin-band";
	...
	async getData () {
		...
		this.router.navigate(["/config/delta-margin-band/list"], {queryParams: params});
		this.listTableData = [];

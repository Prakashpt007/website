...
export class WarehouseListComponent {
	...
	editUrl: string = "/warehouse-qa/bnt-error/warehouse/form";
	listUrl: string = "warehouse-bnt-errors/get-list";
	...
	async getData () {
		...
		this.router.navigate(["/warehouse-qa/bnt-error/warehouse/list"], {queryParams: params});
		this.listTableData = [];

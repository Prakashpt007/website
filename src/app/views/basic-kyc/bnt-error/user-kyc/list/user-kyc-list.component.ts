...
@Component({
	...
	styleUrl: './user-kyc-list.component.scss',
	standalone: false
})
export class UserKycListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/basic-kyc/bnt-error/user-kyc/form";
	listUrl: string = "basic-kyc-bnt-errors/get-list";
	...
	async getData () {
		...
		this.router.navigate(["/basic-kyc/bnt-error/user-kyc/list"], {queryParams: params});
		this.listTableData = [];

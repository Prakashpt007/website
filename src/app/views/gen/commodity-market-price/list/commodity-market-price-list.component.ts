...
@Component({
	selector: 'app-commodity-market-price-list',
	templateUrl: './commodity-market-price-list.component.html',
	styleUrl: './commodity-market-price-list.component.scss',
	standalone: false
})
export class CommodityMarketPriceListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/commodity-market-price/form";
	listUrl: string = "gen/commodity-market-price";
	...
	async getData () {
		...
		this.router.navigate(["/gen/commodity-market-price/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	...
	styleUrls: ['./crop-type-list.component.scss'],
	standalone: false
})
export class CropTypeListComponent {
	...
	editUrl: string = "/agri/crop-type/form";
	listUrl: string = "agri/crop-type";
	...
	async getData () {
		...
		this.router.navigate(["/agri/crop-type/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-workflow-section-list',
	templateUrl: './workflow-section-list.component.html',
	styleUrl: './workflow-section-list.component.scss',
	standalone: false
})
export class WorkflowSectionListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/workflow-section/form";
	listUrl: string = "gen/workflow-section";
	...
	async getData () {
		...
		this.router.navigate(["/gen/workflow-section/list"], {queryParams: params});
		this.listTableData = [];

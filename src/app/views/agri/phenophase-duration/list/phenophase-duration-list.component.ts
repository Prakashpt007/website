...
@Component({
	selector: 'app-phenophase-duration-duration-list',
	templateUrl: './phenophase-duration-list.component.html',
	styleUrls: ['./phenophase-duration-list.component.scss'],
	standalone: false
})
export class PhenophaseDurationListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/agri/phenophase-duration/form";
	listUrl: string = "agri/phenophase-duration";
	...
	async getData () {
		...
		this.router.navigate(["/agri/phenophase-duration/list"], {queryParams: params});
		this.listTableData = [];

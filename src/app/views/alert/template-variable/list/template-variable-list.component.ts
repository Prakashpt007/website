...
@Component({
	...
	styleUrl: './template-variable-list.component.scss',
	standalone: false
})
export class TemplateVariableListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/alert/variable/form";
	listUrl: string = "alert/variable";
	...
	async getData () {
		...
		this.router.navigate(["/alert/variable/list"], {queryParams: params});
		this.listTableData = [];

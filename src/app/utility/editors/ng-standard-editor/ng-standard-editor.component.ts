...
@Component({
	selector: 'app-ng-standard-editor',
	standalone: true,
	imports: [FormsModule, ReactiveFormsModule, CommonModule, AngularEditorModule, DataComponent, MatFormFieldModule],
	templateUrl: './ng-standard-editor.component.html',
	styleUrl: './ng-standard-editor.component.scss'
})
export class NgStandardEditorComponent {

...
@Component({
	selector: 'app-fees-and-taxes-list',
	templateUrl: './fees-and-taxes-list.component.html',
	styleUrl: './fees-and-taxes-list.component.scss',
	standalone: false
})
export class FeesAndTaxesListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/fees-and-taxes/form";
	listUrl: string = "gen/fees-and-taxes";
	...
	async getData () {
		...
		this.router.navigate(["/gen/fees-and-taxes/list"], {queryParams: params});
		this.listTableData = [];

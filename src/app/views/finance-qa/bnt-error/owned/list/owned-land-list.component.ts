...
@Component({
	selector: 'app-owned-land-list',
	templateUrl: './owned-land-list.component.html',
	standalone: false
})
export class OwnedLandListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/finance-qa/bnt-error/owned-land/form";
	listUrl: string = "farm-owned-bnt-error/get-list";
	...
	async getData () {
		...
		this.router.navigate(["/finance-qa/bnt-error/owned-land/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-msp-price-list',
	templateUrl: './msp-price-list.component.html',
	styleUrl: './msp-price-list.component.scss',
	standalone: false
})
export class MspPriceListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/msp-price/form";
	listUrl: string = "gen/msp-price";
	...
	async getData () {
		...
		this.router.navigate(["/gen/msp-price/list"], {queryParams: params});
		this.listTableData = [];

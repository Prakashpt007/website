...
@Component({
	...
	styleUrl: './unpaid-list.component.scss',
	standalone: false
})
export class UnpaidListComponent {
	...
	editUrl: string = "/incomplete/unpaid/edit";
	viewUrl: string = "/incomplete/unpaid/view";
	listUrl: string = "incomplete-cases/get-unpaid-list";
	...
	async getData () {
		...
		this.router.navigate(["/incomplete/unpaid/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-commodity-model-list',
	templateUrl: './commodity-model-list.component.html',
	styleUrls: ['./commodity-model-list.component.scss'],
	standalone: false
})
export class CommodityModelListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/agri/commodity-model/form";
	listUrl: string = "agri/commodity-model";
	...
	async getData () {
		...
		this.router.navigate(["/agri/commodity-model/list"], {queryParams: params});
		this.listTableData = [];

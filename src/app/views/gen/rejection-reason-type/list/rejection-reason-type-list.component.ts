...
@Component({
	selector: 'app-rejection-reason-type-list',
	templateUrl: './rejection-reason-type-list.component.html',
	styleUrls: ['./rejection-reason-type-list.component.scss'],
	standalone: false
})
export class RejectionReasonTypeListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/rejection-reason-type/form";
	listUrl: string = "gen/rejection-reason-type";
	...
	async getData () {
		...
		this.router.navigate(["/gen/rejection-reason-type/list"], {queryParams: params});
		this.listTableData = [];

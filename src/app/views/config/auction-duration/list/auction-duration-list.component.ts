...
@Component({
	selector: 'app-auction-duration-list',
	templateUrl: './auction-duration-list.component.html',
	styleUrl: './auction-duration-list.component.scss',
	standalone: false
})
export class AuctionDurationListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/config/auction-duration/form";
	listUrl: string = "config/auction-duration";
	...
	async getData () {
		...
		this.router.navigate(["/config/auction-duration/list"], {queryParams: params});
		this.listTableData = [];

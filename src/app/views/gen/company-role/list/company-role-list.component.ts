...
export class CompanyRoleListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/company-role/form";
	listUrl: string = "gen/company-role";
	...
	async getData () {
		...
		this.router.navigate(["/gen/company-role/list"], {queryParams: params});
		this.listTableData = [];

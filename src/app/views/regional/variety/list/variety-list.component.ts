...
export class VarietyListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/regional/variety/form";
	listUrl: string = "regional/variety";
	...
	async getData () {
		...
		this.router.navigate(["/regional/variety/list"], {queryParams: params});
		this.listTableData = [];

...
@Component({
	selector: 'app-commodity-quality-parameter-range-list',
	templateUrl: './commodity-quality-parameter-range-list.component.html',
	styleUrl: './commodity-quality-parameter-range-list.component.scss',
	standalone: false
})
export class CommodityQualityParameterRangeListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/agri/quality-parameter-range/edit";
	listUrl: string = "agri/quality-parameter-range";
	...
	async getData () {
		...
		this.router.navigate(["/agri/quality-parameter-range/list"], {queryParams: params});
		this.listTableData = [];

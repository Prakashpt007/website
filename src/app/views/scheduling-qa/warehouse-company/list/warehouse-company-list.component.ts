...
@Component({
	selector: 'app-warehouse-company-list',
	templateUrl: './warehouse-company-list.component.html',
	styleUrl: './warehouse-company-list.component.scss',
	standalone: false
})
export class WarehouseCompanyListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/scheduling-qa/warehouse-company/form";
	listUrl: string = "scheduled-visit/get-warehouse-company-list";
	...
	async getData () {
		...
		this.router.navigate(["/scheduling-qa/warehouse-company/list"], {queryParams: params});
		this.listTableData = [];

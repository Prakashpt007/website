...
@Component({
	selector: 'app-warehouse-farmer-list',
	templateUrl: './warehouse-farmer-list.component.html',
	styleUrl: './warehouse-farmer-list.component.scss',
	standalone: false
})
export class WarehouseFarmerListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/scheduling-qa/warehouse-farmer/form";
	listUrl: string = "scheduled-visit/get-warehouse-farmer-list";
	...
	async getData () {
		...
		this.router.navigate(["/scheduling-qa/warehouse-farmer/list"], {queryParams: params});
		this.listTableData = [];

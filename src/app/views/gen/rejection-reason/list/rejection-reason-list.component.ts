...
export class RejectionReasonListComponent {
	currentIndex = 1;
	page = 1;
	orderBy: string = '';
	order: string = '';
	...
	editUrl: string = "/gen/rejection-reason/form";
	listUrl: string = "gen/rejection-reason";
	...
	async getData () {
		...
		this.router.navigate(["/gen/rejection-reason/list"], {queryParams: params});
		this.listTableData = [];
